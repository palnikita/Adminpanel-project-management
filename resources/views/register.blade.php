...
<body>
    ...
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{ asset('public/')}}/assets/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="{{ asset('public/')}}/assets/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    ...
    <!-- icheck JS
		============================================ -->
    <script src="{{ asset('public/')}}/assets/js/icheck/icheck.min.js"></script>
    <script src="{{ asset('public/')}}/assets/js/icheck/icheck-active.js"></script>
    <!-- plugins JS
		============================================ -->
